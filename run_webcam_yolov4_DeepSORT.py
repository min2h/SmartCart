...
flags.DEFINE_boolean('tiny', False, 'yolo-tiny moodel')
...
MQTT_RECEIVE = "C:\\Users\\bravo\\PycharmProjects\\TINY\\run_webcam_yolov4_DeepSORT"
...
#######################################
    ...
    while True:
        #cv2.imshow("Stream", frame)
        # return_value, frame = cv2.imread(frame)
        #
        # if return_value:
        ...
        detections = [Detection(bbox, score, class_name, feature) for bbox, score, class_name, feature in
                      zip(bboxes, scores_npy, names, features)]
